...
class _AgendaScreenState extends State<AgendaScreen> {
  Future<List<dynamic>> fetchAgenda() async {
    final response =
        await http.get(Uri.parse('https://hayy.my.id/ziqi_api/agenda.php'));
  ...
  Future<void> addAgenda(String judul, String isi, DateTime tgl, String status,
    ...
    final response = await http.post(
      Uri.parse('https://hayy.my.id/ziqi_api/agenda.php'),
  ...
  Future<void> deleteAgenda(String id) async {
    final response = await http.delete(
      Uri.parse('https://hayy.my.id/ziqi_api/agenda.php?kd_agenda=$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.black, Colors.white], // Gradasi hitam ke putih
          ...
          children: [
            FutureBuilder<List<dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return const Center(
                      child: Text('Mohon maaf tidak ada agenda'));
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Dismissible(
                      ...
                      child: Card(
                        color: Colors.grey[300], // Card berwarna abu-abu
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Diterbitkan: ${data['tgl_post_agenda'] ?? ''}',
                                    style: TextStyle(
                                        color: Colors.grey[600], fontSize: 14),
                                  ),
                                ],
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                ...
                backgroundColor:
                    const Color.fromARGB(255, 9, 9, 9), // Warna tombol biru
              ...
              children: [
                ...
                ListTile(
                  title: Text(selectedDate == null
                      ...
                      : 'Tanggal Agenda: ${selectedDate.toLocal()}'
                          .split(' ')[0]),
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (selectedDate != null) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text('Agenda berhasil diedit')));
                      Navigator.pop(context, true);
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text('Silakan pilih tanggal')));
